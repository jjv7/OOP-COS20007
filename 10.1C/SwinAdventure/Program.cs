...
namespace SwinAdventure
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // Create Bags
            Bag laptopBag = new Bag(new string[] { "laptop_bag" }, "laptop bag", "A sleek, black laptop bag. Its fabric is slightly worn from use");
            ...
            while (gameLoop)
            {
                ...
                string? response = command.Execute(player, playerInput);
